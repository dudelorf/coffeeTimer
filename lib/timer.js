...
function Timer(
	...
	Timer.prototype.increaseVolume = function()
	{
		if(!this.timerActive)
		{
			...
			{
				if (this.volume == 6)
					this.decreaseVolumeButton.className = "";
				this.volume += 1;
			}
		}
		if(this.volume == 36)
			this.increaseVolumeButton.className = "disabled";
	};
	Timer.prototype.decreaseVolume = function()
	{
		if(!this.timerActive)
		{
			...
			{
				if (this.volume == 36)
					this.increaseVolumeButton.className = "";
				this.volume -= 1;
			}
		}
		if(this.volume == 6)
			this.decreaseVolumeButton.className = "disabled";
	};
	...
	{		
		if(this.phaseTime == 0)
		{
			...
			//set timeout to reset display
			setTimeout(this.resetDisplay.bind(this), 5000);
			return;
		}
	...
	Timer.prototype.startTimer = function()
	{
		...
		setTimeout(this.decreaseTime.bind(this), 1000);
	};
	...
	{
		this.timerActive = false;
		setTimeout(this.resetDisplay.bind(this), 1500);
	}
